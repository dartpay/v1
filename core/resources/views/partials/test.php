<option data-mobile_code="93" value="Afghanistan" data-code="AF">@lang('Afghanistan')</option>
<option data-mobile_code="358" value="Aland Islands" data-code="AX">>@lang('Aland Islands')</option>
<option data-mobile_code="355" value="Albania" data-code="AL">>@lang('Albania')</option>
<option data-mobile_code="213" value="Algeria" data-code="DZ">>@lang('Algeria')</option>
<option data-mobile_code="1684" value="AmericanSamoa" data-code="AS">>@lang('AmericanSamoa')</option>
<option data-mobile_code="376" value="Andorra" data-code="AD">@lang('Andorra')</option>
<option data-mobile_code="244" value="Angola" data-code="AO">@lang('Angola')</option>
<option data-mobile_code="1264" value="Anguilla" data-code="AI">@lang('Anguilla')</option>
<option data-mobile_code="672" value="Antarctica" data-code="AQ">@lang('Antarctica')</option>
<option data-mobile_code="1268" value="Antigua and Barbuda" data-code="AG">@lang('Antigua and Barbuda')</option>
<option data-mobile_code="54" value="Argentina" data-code="AR">@lang('Argentina')</option>
<option data-mobile_code="374" value="Armenia" data-code="AM">@lang('Armenia')</option>
<option data-mobile_code="297" value="Aruba" data-code="AW">@lang('Aruba')</option>
<option data-mobile_code="61" value="Australia" data-code="AU">@lang('Australia')</option>
<option data-mobile_code="43" value="Austria" data-code="AT">@lang('Austria')</option>
<option data-mobile_code="994" value="Azerbaijan" data-code="AZ">@lang('Azerbaijan')</option>
<option data-mobile_code="1242" value="Bahamas" data-code="BS">@lang('Bahamas')</option>
<option data-mobile_code="973" value="Bahrain" data-code="BH">@lang('Bahrain')</option>
<option data-mobile_code="880" value="Bangladesh" data-code="BD">@lang('Bangladesh')</option>
<option data-mobile_code="1246" value="Barbados" data-code="BB">@lang('Barbados')</option>
<option data-mobile_code="375" value="Belarus" data-code="BY">@lang('Belarus')</option>
<option data-mobile_code="32" value="Belgium" data-code="BE">@lang('Belgium')</option>
<option data-mobile_code="501" value="Belize" data-code="BZ">@lang('Belize')</option>
<option data-mobile_code="229" value="Benin" data-code="BJ">@lang('Benin')</option>
<option data-mobile_code="1441" value="Bermuda" data-code="BM">@lang('Bermuda')</option>
...
<option data-mobile_code="20" value="Egypt" data-code="EG" selected="selected">Egypt</option>
