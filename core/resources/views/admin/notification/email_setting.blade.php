                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="enc">
                                        <option value="ssl" @if($general->mail_config->enc == 'ssl') selected @endif>@lang('SSL')</option>
                                        <option value="tls" @if($general->mail_config->enc == 'tls') selected @endif>@lang('TLS')</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
...
@push('breadcrumb-plugins')
    <button type="button" data-target="#testMailModal" data-toggle="modal" class="btn btn-sm btn-outline--primary">
