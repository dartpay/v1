...
@push('breadcrumb-plugins')
    <button type="button" data-target="#testSMSModal" data-toggle="modal" class="btn btn-outline--primary btn-sm"> <i class="las la-paper-plane"></i> @lang('Send Test SMS')</button>
@endpush
@push('style')
<style>
    .method-select{
