...
@section('panel')
    ...
    <div class="modal fade" id="ipDeleteModal" tabindex="-1" role="dialog" aria-labelledby="ipDeleteModal"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.blocked.ip.delete') }}" method="post">
                    @csrf
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModal"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.blocked.ip.submit') }}" method="post">
                    @csrf
                    <div class="modal-body">
