                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            <div class="form-group col-xl-3">
                                <small>@lang('Logo for Light Background')</small>
                                <div class="image-upload mt-1">
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="profilePicPreview logoPicPrev" style="background-image: url({{ siteLogo() }})">
                            ...
                            <div class="form-group col-xl-3">
                                <small>@lang('Logo for Dark Background')</small>
                                <div class="image-upload mt-1">
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="profilePicUpload2" class="bg--primary">@lang('Select Logo')</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-xl-6">
                                <small>@lang('Favicon')</small>
                                <div class="image-upload mt-1">
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="row">
