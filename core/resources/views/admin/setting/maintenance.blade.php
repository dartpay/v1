                        ...
                        <div class="row">
                                ...
                                <div class="image-upload">
                                    ...
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            ...
                                            <div class="profilePicPreview" style="background-image: url( {{getImage('assets/images/frontend/maintenance/'.$maintenance->data_values->image)}} )">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disabled')" @if (@$general->maintenance_mode) checked @endif name="status">
                                </div>
