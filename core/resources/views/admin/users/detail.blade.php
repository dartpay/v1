            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body p-0">
                    <div class="p-3 bg--white">
                        <div class="">
                            <img src="{{ getImage(imagePath()['profile']['user']['path'].'/'.$user->image)}}" alt="@lang('Profile Image')" class="b-radius--10 w-100">
                        </div>
                        <div class="mt-15">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.users.login', $user->id) }}"
                       class="btn btn--primary btn--shadow btn-block btn-lg">
                        <i class="las la-sign-in-alt"></i>@lang('Login Logs')
                    </a>
                    <a data-bs-toggle="modal" data-bs-target="#addSubModal" href="#addSubModal" class="btn btn--success btn--shadow btn-block btn-lg">
                        @lang('Add/Subtract Balance')
                    </a>
                    @if ($user->status == Status::USER_ACTIVE)
                        <a href="#" class="btn btn--warning btn--gradi btn--shadow w-100 btn-lg userStatus" data-bs-toggle="modal" data-bs-target="#userStatusModal">
                            <i class="las la-ban"></i>@lang('Ban User')
                        </a>
                    @else
                        <a href="#" class="btn btn--success btn--gradi btn--shadow w-100 btn-lg userStatus" data-bs-toggle="modal" data-bs-target="#userStatusModal">
                    ...
                    <a href="{{ route('admin.report.login.history') }}?search={{ $user->username }}"
                       class="btn btn--primary btn--shadow btn-block btn-lg">
                        <i class="las la-sign-in-alt"></i>@lang('Logins')
                    </a>
