            ...
            <div class="card">
                <form action="" class="notify-form">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn w-100 h-45 btn--primary me-2">Submit</button>
                    </div>
                </form>
            </div>
        </div>
...
@push('breadcrumb-plugins')
    <span class="text--primary">Notification will send via @if($general->en) <span class="badge badge--warning">Email</span> @endif @if($general->sn) <span class="badge badge--warning">SMS</span> @endif</span>
@endpush
