                                                        ...
                                                        <div class="thumb">
                                                            <div class="avatar-preview">
                                                                <div class="profilePicPreview"
                                                                     ...
                                                                     style="background-image: url({{getImage('assets/images/frontend/' . $key .'/'. @$content->data_values->$imgKey) }})">
                                        ...
                                        <td data-label="@lang('Image')">
                                            <div class="customer-details d-block">
                                                <a href="javascript:void(0)" class="thumb">
                                                    <img src="{{ getImage('assets/images/frontend/' . $key .'/'. @$data->data_values->$firstKey) }}" alt="@lang('image')">
                                                </a>
                                            </div>
                                        </td>
                                    @endif
