                        ...
                        <div class="form-row mt-4 d-none configForm" id="smtp">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control" name="enc">
                                    <option value="ssl" @if($general_setting->mail_config->enc == 'ssl') selected @endif>@lang('SSL')</option>
                                    <option value="tls" @if($general_setting->mail_config->enc == 'tls') selected @endif>@lang('TLS')</option>
                                </select> 
                            </div>
                            <div class="form-group col-md-6">
