    ...
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            <a href="{{route('admin.dashboard')}}" class="sidebar__main-logo"><img
                    src="{{ siteLogo('dark') }}" alt="@lang('image')"></a>
            <a href="{{route('admin.dashboard')}}" class="sidebar__logo-shape"><img
                    src="{{ siteFavicon() }} " alt="@lang('image')"></a>
            <!-- {{ siteFavicon() }} -->
        </div>
            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.users*',3)}}">
                        ...
                        @if($banned_users_count > 0 || $email_unverified_users_count > 0 || $sms_unverified_users_count > 0 || $kycUnverifiedUsersCount > 0 || $kycPendingUsersCount > 0 )
                   ...
                   <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.exchange.*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive(['admin.exchange.total.proccessing'])}}">
                                <a href="{{route('admin.exchange.total.proccessing')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Proccess Exchange')</span>
                                    @if($pending_exchange)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$pending_exchange}}</span>
                                    @endif
                                </a>
