        ...
        <div class="col-md-10">
            <div class="card custom--card">
                <div class="p-3 d-flex justify-content-between flex-wrap">
                    <h5 class="title">Open Ticket</h5>
                    <a href="https://script.viserlab.com/changalab/demo/ticket" class="btn btn--base btn--sm">
                        <i class="las la-list"></i> My Tickets            
                    </a>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('ticket.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <button class="btn btn--base w-100 mt-3" type="submit" id="recaptcha">
