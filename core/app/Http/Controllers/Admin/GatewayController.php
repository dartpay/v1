...
class GatewayController extends Controller
{
    public function index()
    {
        ...
        return view('admin.gateway.list', compact('page_title', 'empty_message'));
    }
    ...
    public function edit($alias)
    {
        ...
        return view('admin.gateway.edit', compact('page_title', 'supportedCurrencies', 'parameters', 'hasCurrencies', 'currency_idx', 'global_parameters'));
    }
    ...
    public function update(Request $request, $code)
    {
        ...
        return redirect()->route('admin.dasboard')->withNotify($notify);
    }
