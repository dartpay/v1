...
class ManageUsersController extends Controller
{
    ...
    public function kycUnverifiedUsers()
    {
        ...
        return view('admin.users.list', compact('page_title', 'users','empty_message'));
    }
    ...
    public function kycDetails($id)
    {
        ...
        return view('admin.users.kyc_detail', compact('page_title', 'user'));
    }
    ...
    public function kycApprove($id)
    {
        ...
        return redirect()->route('admin.users.kyc.pending')->withNotify($notify);
    }
    ...
    public function showNotificationSingleForm($id)
    {
        ...
        $page_title = 'Send Notification to ' . $user->username;
        return view('admin.users.notification_single', compact('page_title', 'user'));
    }
    ...
    public function showNotificationAllForm()
    {
        ...
        $page_title = 'Notification to Verified Users';
        return view('admin.users.notification_all', compact('page_title', 'users'));
    }
    ...
    public function notificationLog($id)
    {
        ...
        $page_title = 'Notifications Sent to ' . $user->username;
        $logs = NotificationLog::where('user_id', $id)->with('user')->orderBy('id', 'desc')->paginate(getPaginate());
        return view('admin.reports.notification_history', compact('emptyMessage','page_title', 'logs', 'user'));
    }
